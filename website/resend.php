               ...
               <div class="nk-contacts-left">
                  <div class="nk-navbar">
                     <ul class="nk-nav">
						...
						<? if($jezyk == "en"){?>
                           <a href="#"><? echo $english; ?></a>
                           <ul class="dropdown">
                              <li><a href="?l=en"><? echo $english; ?></a></li>
                              <li><a href="?l=pl"><? echo $polish; ?></a></li>
                           </ul>
						<?}elseif($jezyk == "pl"){?>
                           <a href="#"><? echo $polish; ?></a>
                           <ul class="dropdown">
                              <li><a href="?l=pl"><? echo $polish; ?></a></li>
                              <li><a href="?l=en"><? echo $english; ?></a></li>
                           </ul>
               ...
               <div class="nk-contacts-right">
                  <div class="nk-navbar">
                     <ul class="nk-nav">
                        ...
                        <li><a target="_blank" ref="http://youtube.com/c/tejkuus"><span class="ion-social-youtube"></span></a></li>
                     </ul>
                  </div>
               </div>
            </div>
         ...
         <nav class="nk-navbar nk-navbar-top nk-navbar-sticky nk-navbar-transparent nk-navbar-autohide">
            <div class="container">
               <div class="nk-nav-table">
                  <a href="index.php" class="nk-nav-logo"><img src="https://i.imgur.com/AsQjUtl.png" alt="" width="120"></a>
                  <ul class="nk-nav nk-nav-center hidden-md-down" data-nav-mobile="#nk-nav-mobile">
                     <li>
                        <a href="index.php"><? echo $home; ?></a>
                     </li>
                     <li class="">
                        <a href="premium.php"><? echo $premium; ?></a>
                           </li>
                           <li class="">
                              <a href="credits.php"><? echo $credits; ?></a>
                           </li>
                           <li class="">
      ...
      <div id="nk-nav-mobile" class="nk-navbar nk-navbar-side nk-navbar-left-side nk-navbar-overlay-content hidden-lg-up">
         <div class="nano">
            <div class="nano-content">
               <a href="index-2.html" class="nk-nav-logo"><img src="https://i.imgur.com/AsQjUtl.png" alt="" width="90"></a>
...
<?
			...
			<br>
					<a href="http://cschanger.eu/" class="nk-btn nk-btn-md link-effect-1 nk-btn-color-main-5 ready"> '.$przejdznastroneglowna.'</a></div>';
		...
		<div class="container">
			...
			<form method="POST">
				<div class="form-group row">
					<div class="col-sm-10">
						<input name="resend_login" value="<? echo $_POST["login_login"]; ?>" type="text" class="form-control" placeholder="Login" required>
					</div>
				</div>
				<div class="form-group row">
				  <div class="col-sm-10">
					<input name="resend_email" type="text" class="form-control" placeholder="email" required>
				  </div>
				</div>
				...
				<div class="form-group row">
					<div class="col-2"></div>
				  <div class="col-sm-10">
					<button name="login_submit" type="submit"  class="nk-btn nk-btn-lg link-effect-4 ready"><span class="link-effect-inner"><span class="link-effect-l"><span>wyslij ponownie</span></span><span class="link-effect-r"><span>wyslij ponownie</span></span><span class="link-effect-shade"><span>wyslij ponownie</span></span></span></button>
			...
			<?
				...
				echo '<div class="nk-info-box bg-danger"><div class="nk-info-box-icon"><i class="ion-alert-circled"></i></div>twoje konto jest juz potwierdzone
			<br>';
