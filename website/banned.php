      ...
      <div class="nk-main">
         ...
         <div class="nk-box bg-dark-1">
            <div class="container text-center">
			   ...
			   <h3 class="nk-title-back"><? echo $get_login; ?></h3>
               <h2 class="nk-title h1"><center><? echo $banned; ?></center></h2>
               
               <div class="nk-gap-6"></div>
			   <div class="text-center"><h2 class="nk-title h3"><? echo $staybanned; ?> <? echo $permanent; ?></h2><div class="nk-title-sep"></div></div>
 

 <? echo $powodbana; ?> <?if($get_ban == "1"){echo $ban1;}elseif ($get_ban == "2"){echo $ban2;}elseif ($get_ban == "3"){echo $ban3;}elseif ($get_ban == "4"){echo $ban4;};?>
<br>
<? echo $abyuniknac;?>
<br><br><br><br><br>
