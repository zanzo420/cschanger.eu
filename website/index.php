...
<!DOCTYPE html>
<html lang="en">
<meta name="trustpilot-one-time-domain-verification-id" content="Fyz0jhbMf4sExJ4MieOwgwvG7Fkdvb832SbMJgCp"/>
   ...
   <head>
      ...
      <!-- END: Styles --><!-- jQuery --><script src="assets/bower_components/jquery/dist/jquery.min.js"></script>
   </head>
   <!--
      Additional Classes:
          .nk-page-boxed
      ...
      <div class="nk-main">
         ...
         <div class="nk-header-title nk-header-title-lg nk-header-title-parallax nk-header-title-parallax-opacity">
            ...
            <div class="nk-header-table">
               <div class="nk-header-table-cell">
                  <div class="container">
				  <div class="text-center"><h3 class="nk-title-back">CSCHANGER</h3><h2 class="nk-title h1"><? echo $title2; ?></h2><div class="nk-title-sep-icon"><span class="icon"><span class="ion-fireball"></span></span></div></div>
                     <div class="nk-header-text">
                        <h1 class="nk-title display-3"><? echo $trynow; ?></h1>
                        <div class="nk-gap-2"></div>
						<?if(isset($_SESSION["login"])) {?>
						<a href="/panel/" target="_blank" class="nk-btn nk-btn-lg nk-btn-color-main-1 link-effect-4"><span><? echo $panel; ?></span></a> &nbsp;&nbsp;&nbsp;&nbsp; <a href="faq.php" class="nk-btn nk-btn-lg link-effect-4"><span><? echo $checkfaq; ?></span></a>
                        <?}else{?>
                        <a href="register.php" target="_blank" class="nk-btn nk-btn-lg nk-btn-color-main-1 link-effect-4"><span><? echo $register; ?></span></a> &nbsp;&nbsp;&nbsp;&nbsp; <a href="faq.php" class="nk-btn nk-btn-lg link-effect-4"><span><? echo $checkfaq; ?></span></a>
                        <?}?>
         ...
         <div class="container">
            ...
            <div class="row vertical-gap lg-gap">
               <div class="col-md-4">
                  <div class="nk-ibox">
                     <div class="nk-ibox-icon nk-ibox-icon-circle"><i class="fa fa-wrench"></i></div>
                     <div class="nk-ibox-cont">
                        <h2 class="nk-ibox-title"><? echo $dlaczegomy1title; ?></h2>
                        <? echo $dlaczegomy1text; ?>
                     </div>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="nk-ibox">
                     <div class="nk-ibox-icon nk-ibox-icon-circle"><i class="fa fa-windows" aria-hidden="true"></i></div>
                     <div class="nk-ibox-cont">
                        <h2 class="nk-ibox-title"><? echo $dlaczegomy2title; ?></h2>
                        <? echo $dlaczegomy2text; ?>
                     </div>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="nk-ibox">
                     <div class="nk-ibox-icon nk-ibox-icon-circle"><i class="fa fa-commenting-o" aria-hidden="true"></i></div>
                     <div class="nk-ibox-cont">
                        <h2 class="nk-ibox-title"><? echo $dlaczegomy3title; ?></h2>
                        <? echo $dlaczegomy3text; ?>
                     </div>
                  </div>
               </div>
            </div>
         ...
         <div class="nk-box bg-dark-1">
            <div class="container text-center">
               <div class="nk-gap-6"></div>
               <div class="nk-gap-2"></div>
               <h2 class="nk-title h1"><? echo $aboutcschanger; ?></h2>
               <div class="nk-gap-3"></div>
               <p class="lead"><? echo $onastekst; ?></p>
               <div class="nk-gap-2"></div>
               <div class="row no-gutters">
			   
				<?					 
					$query3 = $mysqli->query("SELECT * FROM `users1`");
				...
				?>
                  ...
                  <div class="col-md-4">
                     <div class="nk-box-2 nk-box-line">
                        ...
                        <div class="nk-counter-3">
                           <div class="nk-count"><? echo $num_rows; ?></div>
                           <h3 class="nk-counter-title h4"><? echo $unikalnychuser; ?></h3>
					...
					$query = $mysqli->query("SELECT * FROM `statystyki`");
                  ...
                  <div class="col-md-4">
                     <div class="nk-box-2 nk-box-line">
                        <!-- START: Counter -->
                        <div class="nk-counter-3">
                           <div class="nk-count"><? echo $online;?></div>
                           <h3 class="nk-counter-title h4"><? echo $aktualnie_online; ?></h3>
                           <div class="nk-gap-1"></div>
                        </div>
                        <!-- END: Counter -->
                     </div>
                  ...
                  <div class="col-md-4">
                     <div class="nk-box-2 nk-box-line">
                        <!-- START: Counter -->
                        <div class="nk-counter-3">
                           <div class="nk-count"><? echo $result['ilerazywlaczono']; ?></div>
                           <h3 class="nk-counter-title h4"><? echo $timesused; ?></h3>
                           <div class="nk-gap-1"></div>
                        </div>
                        <!-- END: Counter -->
                     </div>
         ...
         <div class="container">
            <div class="nk-gap-6"></div>
			<div class="text-left"><h3 class="nk-title-back"><? echo $ytsection; ?></h3><h2 class="nk-title h1"><? echo $najnowszevideo; ?></h2></div>
            <div class="nk-gap-2"></div>
            <div class="row">
               <div class="col-md-8 offset-md-2">
                  <div class="nk-plain-video" data-video="https://www.youtube.com/watch?v=sQx_K87RhKw" data-video-thumb="https://i.imgur.com/2ESxiQv.jpg"></div>
               </div>
            </div>
            <div class="nk-gap-2"></div>
            <div class="nk-gap-6"></div>
            ...
            <div class="container">
               <div class="row">
                  <div class="col-md-8 offset-md-2 col-lg-6 offset-lg-3">
                     <h2 class="nk-title text-center h1"><? echo $subscribenews; ?></h2>
                     <div class="nk-gap-3"></div>
                     <!-- START: MailChimp Signup Form -->
                     <form action="#ustawic" method="post" class="nk-mchimp validate" target="_blank">
                        <div class="input-group"><input type="email" value="" name="EMAIL" class="required email form-control" placeholder="Email *"> <button class="nk-btn nk-btn-lg link-effect-4"><? echo $subscribe; ?></button></div>
                        <div class="nk-form-response-success"></div>
                        <div class="nk-form-response-error"></div>
                        <small><? echo $noshareemail; ?></small>
